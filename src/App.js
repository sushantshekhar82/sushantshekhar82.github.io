    ...
    <div className="App">
     ...
     <div id="sushant_shekhar" className='intro'> 
        ...
        <div>
          ...
          <h1 style={{color:'white',fontSize:"40px",fontWeight:"bold"} } className="name">Kumar Sushant Shekhar</h1>
