  ...
  return (
    <div className="App">
        <div className='Nav_Container '>
            ...
            <div>
              <ul id='navitems' className={click?"#navitems":"#navitems active"}>
                <li><a href='#sushant_shekhar'>Home</a></li>
                <li><a href='#aboutme'>About</a></li>
                <li><a href='#skills'>Skills</a></li>
                <li><a href='#projects'>Projects</a></li>
                <li><a href='#contactme'>Contact</a></li>
                <li> <a download href="./Sushant_Shekhar_Resume.pdf"> <Button backgroundColor={"green.400"} style={{display:'inline-block',zIndex:"1"}} zIndex={0}>Resume</Button></a></li>
     ...
     <div id="sushant_shekhar" className='intro'> 
        ...
        <div>
          <h4 style={{color:'blue',fontSize:"16px",marginTop:"5px"}}>Hi there 👋🏽, i'm</h4>
